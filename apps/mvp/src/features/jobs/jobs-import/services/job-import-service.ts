...
export async function postSingleJob(data: any, token: string | null, profileId: string, resumeId: string){
    try{
        await axios.post('/api/jobs/single', { data, profileId, resumeId }, {
            headers: {
