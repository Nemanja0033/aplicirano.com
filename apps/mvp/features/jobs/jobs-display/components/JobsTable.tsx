...
export function JobsTable({ jobs }: { jobs: Job[]; isLoading: boolean }) {
  ...
  return (
    <main className="w-full">
      ...
      <Table
        ref={tableRef}
        className="mt-5 dark:border-[#151046] dark:border-2 dark:bg-gradient-to-b from-[#100c28] to-[#010216] md:w-full w-fit bg-white dark:bg-sidebar rounded-lg shadow-md"
      >
        ...
        <TableBody>
          {jobsToDisplay.map((job: Job) => (
            ...
            >
              ...
              <TableCell className="font-medium text-muted-foreground md:flex hidden">
              ...
              <TableCell className="dark:text-black">
                ...
                <select
                  ...
                  className={`cursor-pointer w-28 p-1 rounded-2xl ${getBadgeLightColor(job.status)} bg-accent`}
